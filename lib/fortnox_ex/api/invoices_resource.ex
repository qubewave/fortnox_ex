...
defmodule FortnoxEx.Api.InvoicesResource do
  ...
  def bookkeep_invoices_resource(connection, document_number, _opts \\ []) do
    request =
      %{}
      |> method(:put)
      |> url("/3/invoices/#{document_number}/bookkeep")
      |> ensure_body()
      |> Enum.into([])
  ...
  def cancel(connection, document_number, _opts \\ []) do
    request =
      %{}
      |> method(:put)
      |> url("/3/invoices/#{document_number}/cancel")
      |> ensure_body()
      |> Enum.into([])
  ...
  def credit(connection, document_number, _opts \\ []) do
    request =
      %{}
      |> method(:put)
      |> url("/3/invoices/#{document_number}/credit")
      |> ensure_body()
      |> Enum.into([])
  ...
  def e_invoice(connection, document_number, _opts \\ []) do
    request =
      %{}
      |> method(:get)
      |> url("/3/invoices/#{document_number}/einvoice")
      |> Enum.into([])
  ...
  def e_print(connection, document_number, _opts \\ []) do
    request =
      %{}
      |> method(:get)
      |> url("/3/invoices/#{document_number}/eprint")
      |> Enum.into([])
  ...
  def email(connection, document_number, _opts \\ []) do
    request =
      %{}
      |> method(:get)
      |> url("/3/invoices/#{document_number}/email")
      |> Enum.into([])
  ...
  def external_print(connection, document_number, _opts \\ []) do
    request =
      %{}
      |> method(:put)
      |> url("/3/invoices/#{document_number}/externalprint")
      |> ensure_body()
      |> Enum.into([])
  ...
  def get_invoices_resource(connection, document_number, _opts \\ []) do
    request =
      %{}
      |> method(:get)
      |> url("/3/invoices/#{document_number}")
      |> Enum.into([])
  ...
  def preview(connection, document_number, _opts \\ []) do
    request =
      %{}
      |> method(:get)
      |> url("/3/invoices/#{document_number}/preview")
      |> Enum.into([])
  ...
  def print(connection, document_number, _opts \\ []) do
    request =
      %{}
      |> method(:get)
      |> url("/3/invoices/#{document_number}/print")
      |> Enum.into([])
  ...
  def print_reminder(connection, document_number, _opts \\ []) do
    request =
      %{}
      |> method(:get)
      |> url("/3/invoices/#{document_number}/printreminder")
      |> Enum.into([])
  ...
  def warehouse_ready(connection, document_number, _opts \\ []) do
    request =
      %{}
      |> method(:put)
      |> url("/3/invoices/#{document_number}/warehouseready")
      |> ensure_body()
      |> Enum.into([])
