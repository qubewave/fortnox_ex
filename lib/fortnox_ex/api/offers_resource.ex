...
defmodule FortnoxEx.Api.OffersResource do
  ...
  def cancel_offers_resource(connection, document_number, _opts \\ []) do
    request =
      %{}
      |> method(:put)
      |> url("/offers/#{document_number}/cancel")
      |> ensure_body()
      |> Enum.into([])
  ...
  def createorder(connection, document_number, _opts \\ []) do
    request =
      %{}
      |> method(:put)
      |> url("/offers/#{document_number}/createorder")
      |> ensure_body()
      |> Enum.into([])
  ...
  def email_offers_resource(connection, document_number, _opts \\ []) do
    request =
      %{}
      |> method(:get)
      |> url("/offers/#{document_number}/email")
      |> Enum.into([])
  ...
  def externalprint(connection, document_number, _opts \\ []) do
    request =
      %{}
      |> method(:put)
      |> url("/offers/#{document_number}/externalprint")
      |> ensure_body()
      |> Enum.into([])
  ...
  def preview_offers_resource(connection, document_number, _opts \\ []) do
    request =
      %{}
      |> method(:get)
      |> url("/offers/#{document_number}/preview")
      |> Enum.into([])
  ...
  def print_offers_resource(connection, document_number, _opts \\ []) do
    request =
      %{}
      |> method(:get)
      |> url("/offers/#{document_number}/print")
      |> Enum.into([])
