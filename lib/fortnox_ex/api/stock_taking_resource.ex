...
defmodule FortnoxEx.Api.StockTakingResource do
  ...
  - `opts` (keyword): Optional parameters
    - `:itemIds` ([String.t]): 
    - `:supplierNumbers` ([String.t]): 
    - `:stockPointIds` ([String.t]): 
    - `:stockLocationIds` ([String.t]): 
    - `:transactionDate` (Date.t): 
    - `:itemIdSearch` (String.t): 
    - `:itemDescriptionSearch` (String.t): 
  ...
  - `opts` (keyword): Optional parameters
    ...
    - `:itemId` (String.t): Include only stock takings with the given item.
  ...
  - `opts` (keyword): Optional parameters
    ...
    - `:startingItemId` (String.t): the itemId that should be on top of the rows list (used to jump to specific row), can be empty
