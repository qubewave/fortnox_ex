...
defmodule FortnoxEx.Api.AssetsResource do
  ...
  def get_deprecation_list(connection, to_date, _opts \\ []) do
    request =
      %{}
      |> method(:get)
      |> url("/assets/depreciations/#{to_date}")
      |> Enum.into([])
  ...
  def write_down(connection, given_number, opts \\ []) do
    ...
    request =
      %{}
      |> method(:put)
      |> url("/assets/writedown/#{given_number}")
      |> add_optional_params(optional_params, opts)
      |> ensure_body()
      |> Enum.into([])
  ...
  def write_up(connection, given_number, opts \\ []) do
    ...
    request =
      %{}
      |> method(:put)
      |> url("/assets/writeup/#{given_number}")
      |> add_optional_params(optional_params, opts)
      |> ensure_body()
      |> Enum.into([])
