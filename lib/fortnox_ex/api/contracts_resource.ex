...
defmodule FortnoxEx.Api.ContractsResource do
  ...
  def createinvoice(connection, document_number, _opts \\ []) do
    request =
      %{}
      |> method(:put)
      |> url("/3/contracts/#{document_number}/createinvoice")
      |> ensure_body()
      |> Enum.into([])
  ...
  def finish(connection, document_number, _opts \\ []) do
    request =
      %{}
      |> method(:put)
      |> url("/3/contracts/#{document_number}/finish")
      |> ensure_body()
      |> Enum.into([])
  ...
  def get_contracts_resource(connection, document_number, _opts \\ []) do
    request =
      %{}
      |> method(:get)
      |> url("/3/contracts/#{document_number}")
      |> Enum.into([])
  ...
  def increaseinvoicecount(connection, document_number, _opts \\ []) do
    request =
      %{}
      |> method(:put)
      |> url("/3/contracts/#{document_number}/increaseinvoicecount")
      |> ensure_body()
      |> Enum.into([])
