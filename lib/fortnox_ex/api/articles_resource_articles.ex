...
defmodule FortnoxEx.Api.ArticlesResourceArticles do
  @moduledoc """
  API calls for all endpoints tagged `ArticlesResourceArticles`.
  """
  ...
  """
  @spec create_articles_resource_articles(Tesla.Env.client, keyword()) :: {:ok, FortnoxEx.Model.ArticleWrap.t} | {:error, Tesla.Env.t}
  def create_articles_resource_articles(connection, opts \\ []) do
    optional_params = %{
      :body => :body
    }
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_articles_resource_articles(Tesla.Env.client, integer(), keyword()) :: {:ok, FortnoxEx.Model.ArticleWrap.t} | {:error, Tesla.Env.t}
  def get_articles_resource_articles(connection, article_number, _opts \\ []) do
    request =
      %{}
      |> method(:get)
      |> url("/articles/#{article_number}")
      |> Enum.into([])
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec list_articles_resource_articles(Tesla.Env.client, keyword()) :: {:ok, FortnoxEx.Model.ArticleListItemList.t} | {:error, Tesla.Env.t}
  def list_articles_resource_articles(connection, opts \\ []) do
    optional_params = %{
      :filter => :query
    }
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec remove_articles_resource_articles(Tesla.Env.client, integer(), keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
  def remove_articles_resource_articles(connection, article_number, _opts \\ []) do
    request =
      %{}
      |> method(:delete)
      |> url("/articles/#{article_number}")
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec update_articles_resource_articles(Tesla.Env.client, integer(), keyword()) :: {:ok, FortnoxEx.Model.ArticleWrap.t} | {:error, Tesla.Env.t}
  def update_articles_resource_articles(connection, article_number, opts \\ []) do
    optional_params = %{
      :body => :body
    }
